 ...
 * @author janhorak
 */
public class BuddyRequestDialog extends javax.swing.JFrame {

    /**
     * Creates new form BuddyRequestDialog
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuddyRequestDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
